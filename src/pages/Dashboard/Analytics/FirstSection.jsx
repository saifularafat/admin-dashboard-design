...
const FirstSection = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 py-7">
            ...
            <div className={`col-span-2 md:flex items-center justify-between gap-5 space-y-5`}>
                    ...
                    <div className="flex items-center justify-between   mt-3">
                        <div className="border-r-2 border-0 border-solid border-slate-300">
                            <div className="flex items-center gap-2 ">
                                ...
                                <p className=" font-medium text-slate-500 md:mr-4 mr-12">Order</p>
                            </div>
                ...
                <div className={`${isDarkMode ? 'bg-slate-900' : 'bg-white'} md:col-span-1 w-full text-accent shadow-2xl  overflow-hidden rounded-xl`}>
                    <div className="p-4">
                    ...
                    <div className="mt-1">
                        <ReactApexChart options={area.optionsSpark3} series={area.seriesSpark3} type="area" height={80} />
                    </div>
                </div>
            </div>
        </div>
